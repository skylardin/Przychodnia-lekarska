...
\paragraph{Tytu³ zadania.} Formularz zapisu dla pacjentów.  \subparagraph{Wykonawca.} £ukasz Mamak, Pawe³ Wilczek. \subparagraph{Realizacja.}  Kod programu (œrodowisko \texttt{verbatim}): \begin{verbatim} <html>
<head>
