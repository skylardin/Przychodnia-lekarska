...
\paragraph{Tytu³ zadania.}Strona logowania pracowników . \subparagraph{Wykonawca.} £ukasz Mamak. \subparagraph{Realizacja.} <<Sprawozdanie z realizacji zadania (w tym ocena zgodnoœci z estymat¹). Kod programu (œrodowisko \texttt{verbatim}): \begin{verbatim} for (i=1; i<10; i++) ... \end{verbatim}>>.

\paragraph{Tytu³ zadania.}Wyœwietlanie, edycja, usuwanie.  \subparagraph{Wykonawca.} £ukasz Szkaradek, Pawe³ Wilczek. \subparagraph{Realizacja.} <<Sprawozdanie z realizacji zadania (w tym ocena zgodnoœci z estymat¹). Kod programu (œrodowisko \texttt{verbatim}): \begin{verbatim} for (i=1; i<10; i++) ... \end{verbatim}>>.
