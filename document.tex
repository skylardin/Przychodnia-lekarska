...
\subsection{Realizacja}
\label{Realizacja2}
\paragraph{Tytu³ zadania.}  Aktualizacja bazy danych. \subparagraph{Wykonawca.} £ukasz Szkaradek. \subparagraph{Realizacja.} <<Sprawozdanie z realizacji zadania (w tym ocena zgodnoœci z estymat¹). Kod programu (œrodowisko \texttt{verbatim}): \begin{verbatim} for (i=1; i<10; i++) ... \end{verbatim}>>.
