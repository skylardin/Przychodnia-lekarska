...
\paragraph{Tytu³ zadania.}  Strona tytu³owa oraz formularz logowania pacjenta. \subparagraph{Wykonawca.} £ukasz Szkaradek \subparagraph{Realizacja.} <<Sprawozdanie z realizacji zadania (w tym ocena zgodnoœci z estymat¹). Kod programu (œrodowisko \texttt{verbatim}):
