...
\paragraph{Tytu³ zadania.}  Mo¿liwoœæ automatycznego wpisywania danych logowania pacjenta po IP. \subparagraph{Wykonawca.} Pawe³ Wilczek, £ukasz Mamak \subparagraph{Realizacja.}  
\newline
\newline
...
\paragraph{Tytu³ zadania.}  Modyfikacja procedury rejestracji pacjenta.  \subparagraph{Wykonawca.} £ukasz Mamak\subparagraph{Realizacja.}  
\newline
\newline
Kod programu (œrodowisko \texttt{verbatim}): \begin{verbatim} \end{verbatim}
