...
\paragraph{Tytu³ zadania.} Strona logowania pracowników . \subparagraph{Wykonawca.} £ukasz Mamak. \subparagraph{Realizacja.} Zadanie polega³o na stworzeniu strony logowania dla pracowników. Realizacja przebieg³a planowo, przyrost zosta³ osi¹gniêty.  Kod programu: \begin{verbatim} ?>
<html>
<head>
<title>Przychodnia lekarska</title>
<META http-equiv=Content-Language content=pl>
...
\subsection{Sprint Review/Demo}\label{Sprint4demo} Sprint koñcowy przebieg³ zgodnie z oczekiwaniami. Naniesione zosta³y istotne poprawki, dodane zosta³y nowe funkcje. Wszystko zosta³o zrealizowane na czas.
\newline
\newline
\textit{Demonstracja przyrostu produktu:}\newline
\newline
...
\bibitem{php} \url{http://php.net/}
\bibitem{w3s} \url{https://www.w3schools.com/php/php_examples.asp}
\bibitem{mysql} \url{https://dev.mysql.com/doc/refman/5.7/en/tutorial.html}
\bibitem{w3s2} \url{https://www.w3schools.com/php/php_mysql_intro.asp}
